...
prepare:
	...
	@cp -r micro-cluster/service/cluster/adapt/template ./
...
mock:
	...
	mockgen -destination ./test/mockmodels/mockresouce/mock_resource_interface.go -package mockresouce -source ./models/resource//readerwriter.go
