...
func Test_ValidArchType(t *testing.T) {
	...
	tests := []struct {
		...
		{"Test_Fail", "x86", want{framework.NewTiEMErrorf(common.TIEM_RESOURCE_INVALID_ARCH, "valid arch type: [%s|%s|%s|%s]",
...
func Test_ValidDiskType(t *testing.T) {
	...
	tests := []struct {
		...
		{"Test_Fail", "sata", want{framework.NewTiEMErrorf(common.TIEM_RESOURCE_INVALID_PURPOSE, "valid disk type: [%s|%s|%s]",
...
func Test_ValidPurposeType(t *testing.T) {
	...
	tests := []struct {
		...
		{"Test_Fail", "sata", want{framework.NewTiEMErrorf(common.TIEM_RESOURCE_INVALID_PURPOSE, "valid purpose name: [%s|%s|%s]",
