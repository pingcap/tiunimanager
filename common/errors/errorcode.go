...
const (
	...
	TIEM_MARSHAL_ERROR      EM_ERROR_CODE = 3
	TIEM_UNMARSHAL_ERROR    EM_ERROR_CODE = 4
	TIEM_SQL_ERROR          EM_ERROR_CODE = 5
...
var explanationContainer = map[EM_ERROR_CODE]ErrorCodeExplanation{
	...
	TIEM_SQL_ERROR:                 {TIEM_SQL_ERROR, "db execute sql error", 500},
