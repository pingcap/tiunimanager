...
var explanationContainer = map[EM_ERROR_CODE]ErrorCodeExplanation{
	...
	TIEM_RESOURCE_CONNECT_TO_HOST_ERROR:     {TIEM_RESOURCE_CONNECT_TO_HOST_ERROR, "connect to host failed", 400},
	TIEM_RESOURCE_NEW_SESSION_ERROR:         {TIEM_RESOURCE_NEW_SESSION_ERROR, "new connect session to host failed", 500},
	TIEM_RESOURCE_RUN_COMMAND_ERROR:         {TIEM_RESOURCE_RUN_COMMAND_ERROR, "run command on host failed", 500},
	TIEM_RESOURCE_HOST_NOT_EXPECTED:         {TIEM_RESOURCE_HOST_NOT_EXPECTED, "host is not expected as import file", 400},
	TIEM_RESOURCE_INIT_FILEBEAT_ERROR:       {TIEM_RESOURCE_INIT_FILEBEAT_ERROR, "install filebeat on host failed", 400},
	...
	// scale out & scale in
	TIEM_INSTANCE_NOT_FOUND:               {TIEM_INSTANCE_NOT_FOUND, "Instance of cluster is not found", 404},
	TIEM_CONNECT_TIDB_ERROR:               {TIEM_CONNECT_TIDB_ERROR, "Failed to connect TiDB instances", 500},
	TIEM_DELETE_INSTANCE_ERROR:            {TIEM_DELETE_INSTANCE_ERROR, "Failed to delete cluster instance", 500},
	TIEM_CHECK_PLACEMENT_RULES_ERROR:      {TIEM_CHECK_PLACEMENT_RULES_ERROR, "Placement rule is not set when scale out TiFlash", 409},
	TIEM_CHECK_TIFLASH_MAX_REPLICAS_ERROR: {TIEM_CHECK_TIFLASH_MAX_REPLICAS_ERROR, "The number of remaining TiFlash instances is less than the maximum replicas of data tables", 409},
	TIEM_SCAN_MAX_REPLICA_COUNT_ERROR:     {TIEM_SCAN_MAX_REPLICA_COUNT_ERROR, "Failed to scan max replicas of data tables of TiFlash", 500},
}
