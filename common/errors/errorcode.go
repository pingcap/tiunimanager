...
const (
	...
	TIEM_USER_PASSWORD_EXPIRED EM_ERROR_CODE = 70615
	...
	TIEM_RESOURCE_BAD_INSTANCE_EXIST        EM_ERROR_CODE = 30146
...
var explanationContainer = map[EM_ERROR_CODE]ErrorCodeExplanation{
	...
	TIEM_USER_PASSWORD_EXPIRED:         {"password expired", 400},
	...
	TIEM_RESOURCE_BAD_INSTANCE_EXIST:        {"already existed a instance with bad status", 500},
