...
const (
	...
	TIEM_BACKUP_PROCESS_FAILED          TIEM_ERROR_CODE = 20601
	TIEM_RESTORE_PROCESS_FAILED         TIEM_ERROR_CODE = 20602
	TIEM_BACKUP_RECORD_CREATE_FAILED    TIEM_ERROR_CODE = 20603
	TIEM_BACKUP_RECORD_DELETE_FAILED    TIEM_ERROR_CODE = 20604
	TIEM_BACKUP_RECORD_QUERY_FAILED     TIEM_ERROR_CODE = 20605
	TIEM_BACKUP_STRATEGY_SAVE_FAILED    TIEM_ERROR_CODE = 20606
	TIEM_BACKUP_STRATEGY_QUERY_FAILED   TIEM_ERROR_CODE = 20607
	TIEM_BACKUP_FILE_DELETE_FAILED      TIEM_ERROR_CODE = 20608

	TIEM_TRANSPORT_SYSTEM_CONFIG_NOT_FOUND TIEM_ERROR_CODE = 60100
	TIEM_EXPORT_PROCESS_FAILED             TIEM_ERROR_CODE = 60101
	TIEM_IMPORT_PARAM_INVALID              TIEM_ERROR_CODE = 60102
	TIEM_IMPORT_PROCESS_FAILED             TIEM_ERROR_CODE = 60103
	TIEM_TRANSPORT_RECORD_NOT_FOUND        TIEM_ERROR_CODE = 60104
	TIEM_TRANSPORT_RECORD_CREATE_FAILED    TIEM_ERROR_CODE = 60105
	TIEM_TRANSPORT_RECORD_DELETE_FAILED    TIEM_ERROR_CODE = 60106
	TIEM_TRANSPORT_RECORD_QUERY_FAILED     TIEM_ERROR_CODE = 60107
...
var explanationContainer = map[TIEM_ERROR_CODE]ErrorCodeExplanation{
	...
	TIEM_TRANSPORT_RECORD_CREATE_FAILED:    {TIEM_TRANSPORT_RECORD_CREATE_FAILED, "create data transport failed", 500},
	TIEM_TRANSPORT_RECORD_DELETE_FAILED:    {TIEM_TRANSPORT_RECORD_DELETE_FAILED, "delete data transport failed", 500},
	TIEM_TRANSPORT_RECORD_QUERY_FAILED:     {TIEM_TRANSPORT_RECORD_QUERY_FAILED, "query data transport failed", 500},
	...
	TIEM_RESTORE_PROCESS_FAILED:         {TIEM_RESTORE_PROCESS_FAILED, "restore process failed", 500},
