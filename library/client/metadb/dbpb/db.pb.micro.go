...
type TiEMDBService interface {
	...
	GetStocks(ctx context.Context, in *DBGetStocksRequest, opts ...client.CallOption) (*DBGetStocksResponse, error)
	// Cluster
	...
	UpdateClusterInfo(ctx context.Context, in *DBUpdateClusterInfoRequest, opts ...client.CallOption) (*DBUpdateClusterInfoResponse, error)
	...
	DeleteTransportRecord(ctx context.Context, in *DBDeleteTransportRequest, opts ...client.CallOption) (*DBDeleteTransportResponse, error)
}
...
func (c *tiEMDBService) GetStocks(ctx context.Context, in *DBGetStocksRequest, opts ...client.CallOption) (*DBGetStocksResponse, error) {
	req := c.c.NewRequest(c.name, "TiEMDBService.GetStocks", in)
	out := new(DBGetStocksResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *tiEMDBService) UpdateClusterInfo(ctx context.Context, in *DBUpdateClusterInfoRequest, opts ...client.CallOption) (*DBUpdateClusterInfoResponse, error) {
	req := c.c.NewRequest(c.name, "TiEMDBService.UpdateClusterInfo", in)
	out := new(DBUpdateClusterInfoResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *tiEMDBService) DeleteTransportRecord(ctx context.Context, in *DBDeleteTransportRequest, opts ...client.CallOption) (*DBDeleteTransportResponse, error) {
	req := c.c.NewRequest(c.name, "TiEMDBService.DeleteTransportRecord", in)
	out := new(DBDeleteTransportResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
	}
...
type TiEMDBServiceHandler interface {
	...
	GetStocks(context.Context, *DBGetStocksRequest, *DBGetStocksResponse) error
	// Cluster
	...
	UpdateClusterInfo(context.Context, *DBUpdateClusterInfoRequest, *DBUpdateClusterInfoResponse) error
	...
	DeleteTransportRecord(context.Context, *DBDeleteTransportRequest, *DBDeleteTransportResponse) error
}
...
func RegisterTiEMDBServiceHandler(s server.Server, hdlr TiEMDBServiceHandler, opts ...server.HandlerOption) error {
	type tiEMDBService interface {
		...
		GetStocks(ctx context.Context, in *DBGetStocksRequest, out *DBGetStocksResponse) error
		...
		DeleteTransportRecord(ctx context.Context, in *DBDeleteTransportRequest, out *DBDeleteTransportResponse) error
	}
	type TiEMDBService struct {
		tiEMDBService
	}
...
func (h *tiEMDBServiceHandler) GetStocks(ctx context.Context, in *DBGetStocksRequest, out *DBGetStocksResponse) error {
	return h.TiEMDBServiceHandler.GetStocks(ctx, in, out)
}
...
func (h *tiEMDBServiceHandler) UpdateClusterInfo(ctx context.Context, in *DBUpdateClusterInfoRequest, out *DBUpdateClusterInfoResponse) error {
	return h.TiEMDBServiceHandler.UpdateClusterInfo(ctx, in, out)
}
...
func (h *tiEMDBServiceHandler) DeleteTransportRecord(ctx context.Context, in *DBDeleteTransportRequest, out *DBDeleteTransportResponse) error {
	return h.TiEMDBServiceHandler.DeleteTransportRecord(ctx, in, out)
}
