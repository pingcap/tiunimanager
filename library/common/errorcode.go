...
const (
	...
	TIEM_CHANGE_FEED_TASK_NOT_FOUND       TIEM_ERROR_CODE = 701
	TIEM_CHANGE_FEED_TASK_DUPLICATE_ID    TIEM_ERROR_CODE = 702
	TIEM_CHANGE_FEED_TASK_STATUS_CONFLICT TIEM_ERROR_CODE = 703
	TIEM_CHANGE_FEED_TASK_LOCK_EXPIRED    TIEM_ERROR_CODE = 704
...
var explanationContainer = map[TIEM_ERROR_CODE]ErrorCodeExplanation{
	...
	// change feed
	TIEM_CHANGE_FEED_TASK_NOT_FOUND:       {TIEM_CHANGE_FEED_TASK_NOT_FOUND, "change feed task not found", 404},
	TIEM_CHANGE_FEED_TASK_DUPLICATE_ID:    {TIEM_CHANGE_FEED_TASK_DUPLICATE_ID, "duplicate id", 500},
	TIEM_CHANGE_FEED_TASK_STATUS_CONFLICT: {TIEM_CHANGE_FEED_TASK_STATUS_CONFLICT, "task status conflict", 409},
	TIEM_CHANGE_FEED_TASK_LOCK_EXPIRED:    {TIEM_CHANGE_FEED_TASK_LOCK_EXPIRED, "task status lock expired", 409},
}
