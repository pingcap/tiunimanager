...
const (
	...
	TIEM_TRANSPORT_RECORD_DEL_FAIL     = 606
	TIEM_BACKUP_PROCESS_FAILED         = 607
	TIEM_RECOVER_PARAM_INVALID         = 608
	TIEM_RECOVER_PROCESS_FAILED        = 609
	TIEM_BACKUP_RECORD_DELETE_FAILED   = 610
	TIEM_BACKUP_RECORD_QUERY_FAILED    = 611
	TIEM_BACKUP_STRATEGY_PARAM_INVALID = 612
	TIEM_BACKUP_STRATEGY_SAVE_FAILED   = 613
	TIEM_BACKUP_STRATEGY_QUERY_FAILED  = 614
	TIEM_MONITOR_NOT_FOUND             = 615
)
...
var TiEMErrMsg = map[TIEM_ERROR_CODE]string{
	...
	TIEM_TRANSPORT_RECORD_DEL_FAIL:     "delete transport record failed",
