...
func TestSecondPartyManager_ClusterExec_Fail(t *testing.T) {
	...
	mockReaderWriter := mocksecondparty.NewMockReaderWriter(mockCtl)
	models.SetSecondPartyOperationReaderWriter(mockReaderWriter)
	mockReaderWriter.EXPECT().Create(context.Background(), secondparty.OperationTypeClusterExec, TestWorkFlowNodeID).Return(nil, expectedErr)
...
func TestSecondPartyManager_ClusterExec_Success(t *testing.T) {
	...
	mockReaderWriter := mocksecondparty.NewMockReaderWriter(mockCtl)
	models.SetSecondPartyOperationReaderWriter(mockReaderWriter)
	mockReaderWriter.EXPECT().Create(context.Background(), secondparty.OperationTypeClusterExec, TestWorkFlowNodeID).Return(&secondPartyOperation, nil)
