...
type MicroSrv interface {
	...
	MicroSrvTiupShowConfig(ctx context.Context, tiupComponent TiUPComponentTypeStr, instanceName string, timeoutS int, flags []string) (resp *CmdShowConfigResp, err error)
	MicroSrvTiupEditGlobalConfig(ctx context.Context, cmdEditGlobalConfigReq CmdEditGlobalConfigReq, bizID uint64) (taskID uint64, err error)
	//MicroSrvTiupEditInstanceConfig(ctx context.Context, tiupComponent TiUPComponentTypeStr, instanceName string, tidbComponent TiDBComponentTypeStr, ip string, port int, configMap map[string]interface{}, timeoutS int, flags []string, bizID uint64) (taskID uint64, err error)
	//MicroSrvTiupReload(ctx context.Context, tiupComponent TiUPComponentTypeStr, instanceName string, timeoutS int, flags []string, bizID uint64) (taskID uint64, err error)
