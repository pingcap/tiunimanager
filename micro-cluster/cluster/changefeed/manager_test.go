...
import (
	...
	"github.com/pingcap-inc/tiunimanager/test/mockmodels/mockchangefeed"
...
func Test_ClusterError(t *testing.T) {
	...
	clusterRW.EXPECT().GetMeta(gomock.Any(), "WithoutCDC").Return(&management.Cluster{}, []*management.ClusterInstance{
		...
		{ClusterID: "WithoutCDC", Name: "root", Password: common.PasswordInExpired{Val: "123455678"}, RoleType: string(constants.Root)},
	}, nil).AnyTimes()
