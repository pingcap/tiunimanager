...
var createClusterFlow = workflow.WorkFlowDefine{
	...
	TaskNodes: map[string]*workflow.NodeDefine{
		...
		"testConnectivityDone":    {"initDatabaseData", "initDataDone", "", workflow.SyncFuncNode, initDatabaseData},
		"initDataDone":            {"waitInitDatabaseData", "success", "", workflow.SyncFuncNode, waitInitDatabaseData},
