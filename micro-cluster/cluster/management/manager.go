...
var createClusterFlow = workflow.WorkFlowDefine{
	...
	TaskNodes: map[string]*workflow.NodeDefine{
		...
		"startupDone":             {"applyParameterGroup", "applyParameterGroupDone", "failAfterDeploy", workflow.SyncFuncNode, workflow.CompositeExecutor(persistCluster, applyParameterGroup)},
		"applyParameterGroupDone": {"initParameters", "initParametersDone", "failAfterDeploy", workflow.SyncFuncNode, initParameters},
		"initParametersDone":      {"setClusterOnline", "onlineDone", "failAfterDeploy", workflow.SyncFuncNode, setClusterOnline},
		"onlineDone":              {"initAccount", "initDone", "failAfterDeploy", workflow.SyncFuncNode, initDatabaseAccount},
