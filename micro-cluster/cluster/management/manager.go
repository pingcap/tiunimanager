...
var createClusterFlow = workflow.WorkFlowDefine{
	...
	TaskNodes: map[string]*workflow.NodeDefine{
		...
		"resourceDone":            {"buildConfig", "configDone", "fail", workflow.SyncFuncNode, buildConfig},
		"configDone":              {"deployCluster", "deployDone", "fail", workflow.PollingNode, deployCluster},
		"deployDone":              {"applyParameterGroup", "applyParameterGroupDone", "fail", workflow.SyncFuncNode, applyParameterGroup},
		"applyParameterGroupDone": {"initParameters", "initParametersDone", "fail", workflow.SyncFuncNode, initParameters},
		"initParametersDone":      {"syncConnectionKey", "syncConnectionKeyDone", "failAfterDeploy", workflow.SyncFuncNode, syncConnectionKey},
		"syncConnectionKeyDone":   {"syncTopology", "syncTopologyDone", "failAfterDeploy", workflow.SyncFuncNode, syncTopology},
