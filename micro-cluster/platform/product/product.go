...
//	var zones []pt.VendorZone
//	for _, zone := range request.Zones {
//		zones = append(zones, pt.VendorZone{VendorID: zone.VendorID, VendorName: zone.VendorName,
...
//}
//
//func (manager *ProductManager) QueryZones(ctx context.Context) (resp message.QueryAvailableVendorsResp, err error) {
//
//	log := framework.LogWithContext(ctx)
...
//	log := framework.LogWithContext(ctx)
//	rw := models.GetProductReaderWriter()
//	product := pt.ProductInfo{VendorID: request.ProductInfo.VendorID,
...
//	}
//	var components []pt.ProductComponentInfo
//	for _, item := range request.Components {
//		components = append(components, pt.ProductComponentInfo{
...
//	log := framework.LogWithContext(ctx)
//	rw := models.GetProductReaderWriter()
//	var sps []pt.VendorSpec
//	for _, spec := range request.Specs {
//		sps = append(sps, pt.VendorSpec{ID: spec.ID, Name: spec.Name, CPU: spec.CPU, Memory: spec.Memory,
