...
var file_cluster_proto_rawDesc = []byte{
	...
	0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x44, 0x54, 0x4f,
	0x52, 0x08, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x22, 0x66, 0x0a, 0x1e, 0x51, 0x75,
	...
	0x61, 0x79, 0x49, 0x6e, 0x66, 0x6f, 0x32, 0xcb, 0x06, 0x0a, 0x0e, 0x43, 0x6c, 0x75, 0x73, 0x74,
	...
	0x72, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x44, 0x54, 0x4f, 0x12, 0x3e,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0c, 0x5a, 0x0a, 0x2e, 0x2f, 0x3b, 0x63, 0x6c, 0x75, 0x73, 0x74,
...
var file_cluster_proto_depIdxs = []int32{
	...
	19, // 60: SaveClusterParametersRequest.operator:type_name -> OperatorDTO
	...
	25, // 67: ClusterService.QueryBackupRecord:input_type -> QueryBackupRequest
	27, // 68: ClusterService.CreateBackup:input_type -> CreateBackupRequest
	29, // 69: ClusterService.RecoverBackupRecord:input_type -> RecoverBackupRequest
	32, // 70: ClusterService.DeleteBackupRecord:input_type -> DeleteBackupRequest
	34, // 71: ClusterService.SaveBackupStrategy:input_type -> SaveBackupStrategyRequest
	36, // 72: ClusterService.GetBackupStrategy:input_type -> GetBackupStrategyRequest
	38, // 73: ClusterService.QueryParameters:input_type -> QueryClusterParametersRequest
	40, // 74: ClusterService.SaveParameters:input_type -> SaveClusterParametersRequest
	1,  // 75: ClusterService.CreateCluster:output_type -> ClusterCreateRespDTO
	3,  // 76: ClusterService.QueryCluster:output_type -> ClusterQueryRespDTO
	5,  // 77: ClusterService.DeleteCluster:output_type -> ClusterDeleteRespDTO
	7,  // 78: ClusterService.DetailCluster:output_type -> ClusterDetailRespDTO
	26, // 79: ClusterService.QueryBackupRecord:output_type -> QueryBackupResponse
	28, // 80: ClusterService.CreateBackup:output_type -> CreateBackupResponse
	30, // 81: ClusterService.RecoverBackupRecord:output_type -> RecoverBackupResponse
	33, // 82: ClusterService.DeleteBackupRecord:output_type -> DeleteBackupResponse
	35, // 83: ClusterService.SaveBackupStrategy:output_type -> SaveBackupStrategyResponse
	37, // 84: ClusterService.GetBackupStrategy:output_type -> GetBackupStrategyResponse
	39, // 85: ClusterService.QueryParameters:output_type -> QueryClusterParametersResponse
	41, // 86: ClusterService.SaveParameters:output_type -> SaveClusterParametersResponse
