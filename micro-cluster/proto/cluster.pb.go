...
var file_cluster_proto_rawDesc = []byte{
	...
	0x0a, 0x08, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x0c, 0x2e, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x44, 0x54, 0x4f, 0x52, 0x08,
	0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x22, 0x95, 0x01, 0x0a, 0x19, 0x44, 0x65, 0x73,
	...
	0x72, 0x6c, 0x12, 0x1c, 0x0a, 0x09, 0x73, 0x68, 0x61, 0x72, 0x65, 0x43, 0x6f, 0x64, 0x65, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x73, 0x68, 0x61, 0x72, 0x65, 0x43, 0x6f, 0x64, 0x65,
	0x32, 0xe8, 0x0d, 0x0a, 0x0e, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76,
...
var file_cluster_proto_msgTypes = make([]protoimpl.MessageInfo, 43)
var file_cluster_proto_goTypes = []interface{}{
	...
	(*DescribeDashboardRequest)(nil),       // 41: DescribeDashboardRequest
	(*DescribeDashboardResponse)(nil),      // 42: DescribeDashboardResponse
	(*OperatorDTO)(nil),                    // 43: OperatorDTO
	...
	(*DataImportRequest)(nil),              // 49: DataImportRequest
	(*DataExportRequest)(nil),              // 50: DataExportRequest
	(*DataTransportQueryRequest)(nil),      // 51: DataTransportQueryRequest
	(*LoginRequest)(nil),                   // 52: LoginRequest
	(*LogoutRequest)(nil),                  // 53: LogoutRequest
	(*VerifyIdentityRequest)(nil),          // 54: VerifyIdentityRequest
	(*ImportHostRequest)(nil),              // 55: ImportHostRequest
	(*ImportHostsInBatchRequest)(nil),      // 56: ImportHostsInBatchRequest
	(*RemoveHostRequest)(nil),              // 57: RemoveHostRequest
	(*RemoveHostsInBatchRequest)(nil),      // 58: RemoveHostsInBatchRequest
	(*ListHostsRequest)(nil),               // 59: ListHostsRequest
	(*CheckDetailsRequest)(nil),            // 60: CheckDetailsRequest
	(*AllocHostsRequest)(nil),              // 61: AllocHostsRequest
	(*GetFailureDomainRequest)(nil),        // 62: GetFailureDomainRequest
	(*DataImportResponse)(nil),             // 63: DataImportResponse
	(*DataExportResponse)(nil),             // 64: DataExportResponse
	(*DataTransportQueryResponse)(nil),     // 65: DataTransportQueryResponse
	(*LoginResponse)(nil),                  // 66: LoginResponse
	(*LogoutResponse)(nil),                 // 67: LogoutResponse
	(*VerifyIdentityResponse)(nil),         // 68: VerifyIdentityResponse
	(*ImportHostResponse)(nil),             // 69: ImportHostResponse
	(*ImportHostsInBatchResponse)(nil),     // 70: ImportHostsInBatchResponse
	(*RemoveHostResponse)(nil),             // 71: RemoveHostResponse
	(*RemoveHostsInBatchResponse)(nil),     // 72: RemoveHostsInBatchResponse
	(*ListHostsResponse)(nil),              // 73: ListHostsResponse
	(*CheckDetailsResponse)(nil),           // 74: CheckDetailsResponse
	(*AllocHostResponse)(nil),              // 75: AllocHostResponse
	(*GetFailureDomainResponse)(nil),       // 76: GetFailureDomainResponse
}
var file_cluster_proto_depIdxs = []int32{
	43, // 0: ClusterCreateReqDTO.operator:type_name -> OperatorDTO
	...
	43, // 6: ClusterQueryReqDTO.operator:type_name -> OperatorDTO
	...
	43, // 11: ClusterDeleteReqDTO.operator:type_name -> OperatorDTO
	...
	43, // 14: ClusterDetailReqDTO.operator:type_name -> OperatorDTO
	...
	43, // 40: BackupRecordDTO.operator:type_name -> OperatorDTO
	...
	43, // 46: CreateBackupRequest.operator:type_name -> OperatorDTO
	...
	43, // 49: RecoverBackupRequest.operator:type_name -> OperatorDTO
	...
	43, // 53: DeleteBackupRequest.operator:type_name -> OperatorDTO
	44, // 54: DeleteBackupResponse.status:type_name -> ResponseStatusDTO
	43, // 55: SaveBackupStrategyRequest.operator:type_name -> OperatorDTO
	44, // 56: SaveBackupStrategyResponse.status:type_name -> ResponseStatusDTO
	43, // 57: GetBackupStrategyRequest.operator:type_name -> OperatorDTO
	44, // 58: GetBackupStrategyResponse.status:type_name -> ResponseStatusDTO
	43, // 59: QueryClusterParametersRequest.operator:type_name -> OperatorDTO
	44, // 60: QueryClusterParametersResponse.status:type_name -> ResponseStatusDTO
	43, // 61: SaveClusterParametersRequest.operator:type_name -> OperatorDTO
	...
	43, // 64: DescribeDashboardRequest.operator:type_name -> OperatorDTO
	...
	49, // 70: ClusterService.ImportData:input_type -> DataImportRequest
	50, // 71: ClusterService.ExportData:input_type -> DataExportRequest
	51, // 72: ClusterService.DescribeDataTransport:input_type -> DataTransportQueryRequest
	24, // 73: ClusterService.QueryBackupRecord:input_type -> QueryBackupRequest
	26, // 74: ClusterService.CreateBackup:input_type -> CreateBackupRequest
	28, // 75: ClusterService.RecoverBackupRecord:input_type -> RecoverBackupRequest
	31, // 76: ClusterService.DeleteBackupRecord:input_type -> DeleteBackupRequest
	33, // 77: ClusterService.SaveBackupStrategy:input_type -> SaveBackupStrategyRequest
	35, // 78: ClusterService.GetBackupStrategy:input_type -> GetBackupStrategyRequest
	37, // 79: ClusterService.QueryParameters:input_type -> QueryClusterParametersRequest
	39, // 80: ClusterService.SaveParameters:input_type -> SaveClusterParametersRequest
	41, // 81: ClusterService.DescribeDashboard:input_type -> DescribeDashboardRequest
	52, // 82: ClusterService.Login:input_type -> LoginRequest
	53, // 83: ClusterService.Logout:input_type -> LogoutRequest
	54, // 84: ClusterService.VerifyIdentity:input_type -> VerifyIdentityRequest
	55, // 85: ClusterService.ImportHost:input_type -> ImportHostRequest
	56, // 86: ClusterService.ImportHostsInBatch:input_type -> ImportHostsInBatchRequest
	57, // 87: ClusterService.RemoveHost:input_type -> RemoveHostRequest
	58, // 88: ClusterService.RemoveHostsInBatch:input_type -> RemoveHostsInBatchRequest
	59, // 89: ClusterService.ListHost:input_type -> ListHostsRequest
	60, // 90: ClusterService.CheckDetails:input_type -> CheckDetailsRequest
	61, // 91: ClusterService.AllocHosts:input_type -> AllocHostsRequest
	62, // 92: ClusterService.GetFailureDomain:input_type -> GetFailureDomainRequest
	1,  // 93: ClusterService.CreateCluster:output_type -> ClusterCreateRespDTO
	3,  // 94: ClusterService.QueryCluster:output_type -> ClusterQueryRespDTO
	5,  // 95: ClusterService.DeleteCluster:output_type -> ClusterDeleteRespDTO
	7,  // 96: ClusterService.DetailCluster:output_type -> ClusterDetailRespDTO
	63, // 97: ClusterService.ImportData:output_type -> DataImportResponse
	64, // 98: ClusterService.ExportData:output_type -> DataExportResponse
	65, // 99: ClusterService.DescribeDataTransport:output_type -> DataTransportQueryResponse
	25, // 100: ClusterService.QueryBackupRecord:output_type -> QueryBackupResponse
	27, // 101: ClusterService.CreateBackup:output_type -> CreateBackupResponse
	29, // 102: ClusterService.RecoverBackupRecord:output_type -> RecoverBackupResponse
	32, // 103: ClusterService.DeleteBackupRecord:output_type -> DeleteBackupResponse
	34, // 104: ClusterService.SaveBackupStrategy:output_type -> SaveBackupStrategyResponse
	36, // 105: ClusterService.GetBackupStrategy:output_type -> GetBackupStrategyResponse
	38, // 106: ClusterService.QueryParameters:output_type -> QueryClusterParametersResponse
	40, // 107: ClusterService.SaveParameters:output_type -> SaveClusterParametersResponse
	42, // 108: ClusterService.DescribeDashboard:output_type -> DescribeDashboardResponse
	66, // 109: ClusterService.Login:output_type -> LoginResponse
	67, // 110: ClusterService.Logout:output_type -> LogoutResponse
	68, // 111: ClusterService.VerifyIdentity:output_type -> VerifyIdentityResponse
	69, // 112: ClusterService.ImportHost:output_type -> ImportHostResponse
	70, // 113: ClusterService.ImportHostsInBatch:output_type -> ImportHostsInBatchResponse
	71, // 114: ClusterService.RemoveHost:output_type -> RemoveHostResponse
	72, // 115: ClusterService.RemoveHostsInBatch:output_type -> RemoveHostsInBatchResponse
	73, // 116: ClusterService.ListHost:output_type -> ListHostsResponse
	74, // 117: ClusterService.CheckDetails:output_type -> CheckDetailsResponse
	75, // 118: ClusterService.AllocHosts:output_type -> AllocHostResponse
	76, // 119: ClusterService.GetFailureDomain:output_type -> GetFailureDomainResponse
	93, // [93:120] is the sub-list for method output_type
	66, // [66:93] is the sub-list for method input_type
