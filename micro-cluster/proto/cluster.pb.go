...
var file_cluster_proto_rawDesc = []byte{
	...
	0x6e, 0x66, 0x6f, 0x32, 0xcb, 0x06, 0x0a, 0x0e, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x53,
	...
	0x74, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x44, 0x54, 0x4f, 0x12, 0x3e, 0x0a, 0x11, 0x51,
...
var file_cluster_proto_depIdxs = []int32{
	...
	25, // 68: ClusterService.QueryBackupRecord:input_type -> QueryBackupRequest
	27, // 69: ClusterService.CreateBackup:input_type -> CreateBackupRequest
	29, // 70: ClusterService.RecoverBackupRecord:input_type -> RecoverBackupRequest
	32, // 71: ClusterService.DeleteBackupRecord:input_type -> DeleteBackupRequest
	34, // 72: ClusterService.SaveBackupStrategy:input_type -> SaveBackupStrategyRequest
	36, // 73: ClusterService.GetBackupStrategy:input_type -> GetBackupStrategyRequest
	38, // 74: ClusterService.QueryParameters:input_type -> QueryClusterParametersRequest
	40, // 75: ClusterService.SaveParameters:input_type -> SaveClusterParametersRequest
	1,  // 76: ClusterService.CreateCluster:output_type -> ClusterCreateRespDTO
	3,  // 77: ClusterService.QueryCluster:output_type -> ClusterQueryRespDTO
	5,  // 78: ClusterService.DeleteCluster:output_type -> ClusterDeleteRespDTO
	7,  // 79: ClusterService.DetailCluster:output_type -> ClusterDetailRespDTO
	26, // 80: ClusterService.QueryBackupRecord:output_type -> QueryBackupResponse
	28, // 81: ClusterService.CreateBackup:output_type -> CreateBackupResponse
	30, // 82: ClusterService.RecoverBackupRecord:output_type -> RecoverBackupResponse
	33, // 83: ClusterService.DeleteBackupRecord:output_type -> DeleteBackupResponse
	35, // 84: ClusterService.SaveBackupStrategy:output_type -> SaveBackupStrategyResponse
	37, // 85: ClusterService.GetBackupStrategy:output_type -> GetBackupStrategyResponse
	39, // 86: ClusterService.QueryParameters:output_type -> QueryClusterParametersResponse
	41, // 87: ClusterService.SaveParameters:output_type -> SaveClusterParametersResponse
