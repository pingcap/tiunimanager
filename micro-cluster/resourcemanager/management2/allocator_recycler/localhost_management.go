...
import (
	...
	"github.com/pingcap-inc/tiem/micro-cluster/resourcemanager/management2/structs"
...
func (m *LocalHostManagement) AllocResources(ctx context.Context, batchReq *structs.AllocRequest) (results *structs.AllocResponse, err error) {
