...
type AllocRequest struct {
	Mode              string           // Easy Mode/Full Path Mode
	Vendor            string           // Local/AWS
	Location          structs.Location // location
	Arch              string           // X86_64/Arm64
	PoolType          string           // GeneralPool/ReservedPool/ExclusivePool/ElasticPool
	ProductType       int64            // product trait is also okay (TiDB)
	Applicant         Applicant
