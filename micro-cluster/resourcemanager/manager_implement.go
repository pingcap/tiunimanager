...
func (m *ResourceManager) ImportHosts(ctx context.Context, hosts []structs.HostInfo) (flowId string, hostIds []string, err error) {
	flowId, hostIds, err = m.resourcePool.ImportHosts(ctx, hosts)
	if err != nil {
