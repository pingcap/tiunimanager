...
func (mgr *RBACManager) initDefaultRBAC(ctx context.Context) {
	...
	mgr.DeleteRole(ctx, message.DeleteRoleReq{Role: string(constants.RbacRoleAdmin)})
	...
	mgr.DeleteRole(ctx, message.DeleteRoleReq{Role: string(constants.RbacRoleClusterManager)})
	...
	mgr.DeleteRole(ctx, message.DeleteRoleReq{Role: string(constants.RbacRolePlatformManager)})
