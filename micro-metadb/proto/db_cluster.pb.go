...
var file_db_cluster_proto_rawDesc = []byte{
	...
	0x54, 0x4f, 0x52, 0x04, 0x70, 0x61, 0x67, 0x65, 0x22, 0xde, 0x01, 0x0a, 0x12, 0x44, 0x42, 0x52,
...
var file_db_cluster_proto_msgTypes = make([]protoimpl.MessageInfo, 41)
var file_db_cluster_proto_goTypes = []interface{}{
	...
	(*DBRecoverRecordDTO)(nil),             // 33: DBRecoverRecordDTO
	(*DBSaveRecoverRecordRequest)(nil),     // 34: DBSaveRecoverRecordRequest
	(*DBSaveRecoverRecordResponse)(nil),    // 35: DBSaveRecoverRecordResponse
	(*DBBackupStrategyDTO)(nil),            // 36: DBBackupStrategyDTO
	(*DBSaveBackupStrategyRequest)(nil),    // 37: DBSaveBackupStrategyRequest
	(*DBSaveBackupStrategyResponse)(nil),   // 38: DBSaveBackupStrategyResponse
	(*DBQueryBackupStrategyRequest)(nil),   // 39: DBQueryBackupStrategyRequest
	(*DBQueryBackupStrategyResponse)(nil),  // 40: DBQueryBackupStrategyResponse
	(*DBFlowDTO)(nil),                      // 41: DBFlowDTO
}
var file_db_cluster_proto_depIdxs = []int32{
	...
	41, // 35: DBDBBackupRecordDisplayDTO.flow:type_name -> DBFlowDTO
	...
	33, // 39: DBSaveRecoverRecordRequest.recoverRecord:type_name -> DBRecoverRecordDTO
	0,  // 40: DBSaveRecoverRecordResponse.status:type_name -> DBClusterResponseStatus
	33, // 41: DBSaveRecoverRecordResponse.recoverRecord:type_name -> DBRecoverRecordDTO
	36, // 42: DBSaveBackupStrategyRequest.strategy:type_name -> DBBackupStrategyDTO
	0,  // 43: DBSaveBackupStrategyResponse.status:type_name -> DBClusterResponseStatus
	36, // 44: DBSaveBackupStrategyResponse.strategy:type_name -> DBBackupStrategyDTO
	0,  // 45: DBQueryBackupStrategyResponse.status:type_name -> DBClusterResponseStatus
	36, // 46: DBQueryBackupStrategyResponse.strategy:type_name -> DBBackupStrategyDTO
