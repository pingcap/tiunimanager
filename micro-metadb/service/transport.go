...
import (
	"context"
	"github.com/pingcap-inc/tiem/library/client/metadb"
...
func (d *DBServiceHandler)CreateTransportRecord(ctx context.Context, in *metadb.db, out *metadb.db) error {
...
func (d *DBServiceHandler)UpdateTransportRecord(ctx context.Context, in *metadb.db, out *metadb.db) error {
	log := framework.LogWithContext(ctx)
...
func (d *DBServiceHandler)FindTrasnportRecordByID(ctx context.Context, in *metadb.db, out *metadb.db) error {
	log := framework.LogWithContext(ctx)
...
func (d *DBServiceHandler)ListTrasnportRecord(ctx context.Context, in *metadb.db, out *metadb.db) error {
	log := framework.LogWithContext(ctx)
	...
	out.Records = make([]*metadb.db, len(records))
...
func convertRecordDTO(record *models.TransportRecord) *metadb.db {
	recordDTO := &metadb.db{
