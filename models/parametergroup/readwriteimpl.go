...
func (m ParameterGroupReadWrite) CreateParameterGroup(ctx context.Context, pg *ParameterGroup, pgm []*ParameterGroupMapping) (*ParameterGroup, error) {
	...
	if err != nil {
		...
		tx.Rollback()
		return nil, framework.SimpleError(common.TIEM_PARAMETER_GROUP_CREATE_ERROR)
	}
...
func (m ParameterGroupReadWrite) DeleteParameterGroup(ctx context.Context, parameterGroupId string) (err error) {
	...
	if err != nil {
		...
		tx.Rollback()
		return framework.SimpleError(common.TIEM_PARAMETER_GROUP_DELETE_ERROR)
	}
	tx.Commit()
	return
}
...
func (m ParameterGroupReadWrite) UpdateParameterGroup(ctx context.Context, pg *ParameterGroup, pgm []*ParameterGroupMapping) (err error) {
	...
	if err != nil {
		...
		tx.Rollback()
		return framework.SimpleError(common.TIEM_PARAMETER_GROUP_UPDATE_ERROR)
	}
	...
	for i := range pgm {
		...
		if err != nil {
			...
			tx.Rollback()
			return framework.SimpleError(common.TIEM_PARAMETER_GROUP_UPDATE_RELATION_PARAM_ERROR)
		}
	}
	tx.Commit()
	return
...
func (m ParameterGroupReadWrite) QueryParameterGroup(ctx context.Context, name, clusterSpec, clusterVersion string, dbType, hasDefault int, offset, size int) (groups []*ParameterGroup, total int64, err error) {
	...
	if err != nil {
		...
		return nil, 0, framework.SimpleError(common.TIEM_PARAMETER_GROUP_QUERY_ERROR)
	}
...
func (m ParameterGroupReadWrite) GetParameterGroup(ctx context.Context, parameterGroupId string) (group *ParameterGroup, params []*ParamDetail, err error) {
	...
	if err != nil {
		...
		return nil, nil, framework.SimpleError(common.TIEM_PARAMETER_GROUP_QUERY_ERROR)
	}

	params, err = m.QueryParametersByGroupId(ctx, parameterGroupId)
	if err != nil {
		log.Errorf("get param group err: %v", err.Error())
		return nil, nil, framework.SimpleError(common.TIEM_PARAMETER_QUERY_ERROR)
	}
	return
}
...
func (m ParameterGroupReadWrite) CreateParameter(ctx context.Context, parameter *Parameter) (*Parameter, error) {
	...
	if err != nil {
		...
		return nil, framework.SimpleError(common.TIEM_PARAMETER_CREATE_ERROR)
	}
...
func (m ParameterGroupReadWrite) DeleteParameter(ctx context.Context, parameterId string) (err error) {
	...
	if err != nil {
		...
		return framework.SimpleError(common.TIEM_PARAMETER_CREATE_ERROR)
	}
	return nil
}
...
func (m ParameterGroupReadWrite) UpdateParameter(ctx context.Context, parameter *Parameter) (err error) {
	...
	if err != nil {
		...
		return framework.SimpleError(common.TIEM_PARAMETER_UPDATE_ERROR)
	}
	return err
}
...
func (m ParameterGroupReadWrite) QueryParametersByGroupId(ctx context.Context, parameterGroupId string) (params []*ParamDetail, err error) {
	...
	if err != nil {
		...
		return nil, framework.SimpleError(common.TIEM_PARAMETER_QUERY_ERROR)
	}
	return
}
...
func (m ParameterGroupReadWrite) GetParameter(ctx context.Context, parameterId string) (parameter *Parameter, err error) {
	...
	if err != nil {
		...
		return nil, framework.SimpleError(common.TIEM_PARAMETER_DETAIL_ERROR)
	}
	return parameter, err
}
