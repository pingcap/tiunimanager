...
//}
//
//var NoInternalProducts = []ProductInfo{
//	{VendorID: AliYun, RegionID: CNHangzhou, ProductID: "TiDB", Name: "TiDB", Version: TiDBVersion50, Arch: string(constants.ArchX8664), Status: string(constants.ProductStatusOnline), Internal: constants.EMInternalProductNo},
//	{VendorID: AliYun, RegionID: CNHangzhou, ProductID: "TiDB", Name: "TiDB", Version: TiDBVersion51, Arch: string(constants.ArchArm64), Status: string(constants.ProductStatusOnline), Internal: constants.EMInternalProductNo},
//	{VendorID: AliYun, RegionID: CNBeijing, ProductID: "TiDB", Name: "TiDB", Version: TiDBVersion50, Arch: string(constants.ArchX8664), Status: string(constants.ProductStatusOnline), Internal: constants.EMInternalProductNo},
//	{VendorID: AliYun, RegionID: CNBeijing, ProductID: "TiDB", Name: "TiDB", Version: TiDBVersion51, Arch: string(constants.ArchX8664), Status: string(constants.ProductStatusOnline), Internal: constants.EMInternalProductNo},
//}
//
//var HangZhouProducts = []ProductInfo{
//	{VendorID: AliYun, RegionID: CNHangzhou, ProductID: "TiDB", Name: "TiDB", Version: TiDBVersion50, Arch: string(constants.ArchX8664), Status: string(constants.ProductStatusOnline), Internal: constants.EMInternalProductNo},
//	{VendorID: AliYun, RegionID: CNHangzhou, ProductID: "TiDB", Name: "TiDB", Version: TiDBVersion51, Arch: string(constants.ArchArm64), Status: string(constants.ProductStatusOnline), Internal: constants.EMInternalProductNo},
//}
//var HangZhouProductCtrplan = []ProductInfo{
//	{VendorID: AliYun, RegionID: CNHangzhou, ProductID: "EnterpriseManager", Name: "EnterpriseManager", Version: EnterpriseManagerVersion, Arch: string(constants.ArchX8664), Status: string(constants.ProductStatusOnline), Internal: constants.EMInternalProductYes},
//}
//var BeijingProducts = []ProductInfo{
//	{VendorID: AliYun, RegionID: CNBeijing, ProductID: "TiDB", Name: "TiDB", Version: TiDBVersion50, Arch: string(constants.ArchX8664), Status: string(constants.ProductStatusOnline), Internal: constants.EMInternalProductNo},
//	{VendorID: AliYun, RegionID: CNBeijing, ProductID: "TiDB", Name: "TiDB", Version: TiDBVersion51, Arch: string(constants.ArchX8664), Status: string(constants.ProductStatusOnline), Internal: constants.EMInternalProductNo},
//}
//
//var TiDBALIYUNHZX8650Components = []ProductComponentInfo{
//	//TiDB v5.0.0
...
//}
//
//var TiDBALIYUNBJX8650Components = []ProductComponentInfo{
//	//TiDB v5.0.0
...
//}
//
//var TiDBALIYUNBJX8651Components = []ProductComponentInfo{
//	//TiDB v5.1.0
...
//}
//
//var TiDBALIYUNHZARM6451Components = []ProductComponentInfo{
//	//TiDB v5.1.0
...
//}
//
//var EMALIYUNHZX8610Components = []ProductComponentInfo{
...
//		err := prw.CreateZones(context.TODO(), make([]VendorZone, 0))
...
//		err := prw.CreateProduct(context.TODO(), ProductInfo{}, make([]ProductComponentInfo, 0))
//		assert.Equal(t, errors.TIEM_PARAMETER_INVALID, err.(errors.EMError).GetCode())
//	})
//	//CreateProducts
//	{
...
//			wants   []func(args args, prw *ProductReadWriter) bool
//		}{
//			{"CreateTiDBProductWithAliYunHangzhou51ARM64", args{ProductInfo: ProductInfo{VendorID: AliYun, RegionID: CNHangzhou, ProductID: TiDB, Version: TiDBVersion51, Arch: string(constants.ArchArm64), Name: TiDB, Status: string(constants.ProductStatusOnline), Internal: constants.EMInternalProductNo}, Components: TiDBALIYUNHZARM6451Components},
//				false, []func(args args, prw *ProductReadWriter) bool{}},
//			{"CreateTiDBProductWithAliYunHangzhou50x8664", args{ProductInfo: ProductInfo{VendorID: AliYun, RegionID: CNHangzhou, ProductID: TiDB, Version: TiDBVersion50, Arch: string(constants.ArchX8664), Name: TiDB, Status: string(constants.ProductStatusOnline), Internal: constants.EMInternalProductNo}, Components: TiDBALIYUNHZX8650Components},
//				false, []func(args args, prw *ProductReadWriter) bool{}},
//			{"CreateTiDBProductWithAliYunBeijing50x8664", args{ProductInfo: ProductInfo{VendorID: AliYun, RegionID: CNBeijing, ProductID: TiDB, Version: TiDBVersion50, Arch: string(constants.ArchX8664), Name: TiDB, Status: string(constants.ProductStatusOnline), Internal: constants.EMInternalProductNo}, Components: TiDBALIYUNBJX8650Components},
//				false, []func(args args, prw *ProductReadWriter) bool{}},
//			{"CreateTiDBProductWithAliYunBeijing51x8664", args{ProductInfo: ProductInfo{VendorID: AliYun, RegionID: CNBeijing, ProductID: TiDB, Version: TiDBVersion51, Arch: string(constants.ArchX8664), Name: TiDB, Status: string(constants.ProductStatusOnline), Internal: constants.EMInternalProductNo}, Components: TiDBALIYUNBJX8651Components},
//				false, []func(args args, prw *ProductReadWriter) bool{}},
//			{"CreateEMProductWithAliYunHangzhou10x8664", args{ProductInfo: ProductInfo{VendorID: AliYun, RegionID: CNHangzhou, ProductID: EnterpriseManager, Version: EnterpriseManagerVersion, Arch: string(constants.ArchX8664), Name: EnterpriseManager, Status: string(constants.ProductStatusOnline), Internal: constants.EMInternalProductYes}, Components: EMALIYUNHZX8610Components},
//				false, []func(args args, prw *ProductReadWriter) bool{}},
//		}
//
//		for _, tt := range tests {
//			t.Run(tt.name, func(t *testing.T) {
//				err := prw.CreateProduct(context.TODO(), tt.args.ProductInfo, tt.args.Components)
//				assert.NoError(t, err)
//				if nil != err {
//					info := tt.args.ProductInfo
//					key := info.VendorID + info.RegionID + info.ProductID + info.Name + info.Arch + info.Version
//					_, ok := products[key]
//					if !ok {
//						products[key] = tt.args.ProductInfo
//					}
//				}
//			})
//		}
//
//		var tmp []structs.ProductInfo
...
//
//		dmap := make(map[string]structs.ProductInfo)
...
//		product := ProductInfo{VendorID: AliYun, RegionID: CNHangzhou, ProductID: TiDB, Version: TiDBVersion51, Arch: string(constants.ArchArm64), Name: TiDB, Status: string(constants.ProductStatusOnline), Internal: constants.EMInternalProductNo}
...
//		newProduct := ProductInfo{VendorID: AliYun, RegionID: CNHangzhou, ProductID: TiDB, Version: TiDBVersion50, Arch: string(constants.ArchX8664), Name: TiDB, Status: string(constants.ProductStatusOnline), Internal: constants.EMInternalProductNo}
...
//		err := prw.CreateZones(context.TODO(), zones)
//		assert.NoError(t, err)
//		TiDBHZ50X8664 := ProductInfo{VendorID: AliYun, RegionID: CNHangzhou, ProductID: TiDB, Version: TiDBVersion50, Arch: string(constants.ArchX8664), Status: string(constants.ProductStatusOnline), Internal: constants.EMInternalProductNo}
//		err = prw.CreateProduct(context.TODO(), TiDBHZ50X8664, TiDBALIYUNHZX8650Components)
//		assert.NoError(t, err)
//		TiDBHZ51ARM64 := ProductInfo{VendorID: AliYun, RegionID: CNHangzhou, ProductID: TiDB, Version: TiDBVersion51, Arch: string(constants.ArchArm64), Status: string(constants.ProductStatusOnline), Internal: constants.EMInternalProductNo}
//		err = prw.CreateProduct(context.TODO(), TiDBHZ51ARM64, TiDBALIYUNHZARM6451Components)
//		assert.NoError(t, err)
//		TiDBBJ50X8664 := ProductInfo{VendorID: AliYun, RegionID: CNBeijing, ProductID: TiDB, Version: TiDBVersion50, Arch: string(constants.ArchX8664), Status: string(constants.ProductStatusOnline), Internal: constants.EMInternalProductNo}
//		err = prw.CreateProduct(context.TODO(), TiDBBJ50X8664, TiDBALIYUNBJX8650Components)
//		assert.NoError(t, err)
//		TiDBBJ51X8664 := ProductInfo{VendorID: AliYun, RegionID: CNBeijing, ProductID: TiDB, Version: TiDBVersion51, Arch: string(constants.ArchX8664), Status: string(constants.ProductStatusOnline), Internal: constants.EMInternalProductNo}
//		err = prw.CreateProduct(context.TODO(), TiDBBJ51X8664, TiDBALIYUNBJX8651Components)
//		assert.NoError(t, err)
//		EMHHZ10X8664 := ProductInfo{VendorID: AliYun, RegionID: CNHangzhou, ProductID: EnterpriseManager, Version: EnterpriseManagerVersion, Arch: string(constants.ArchX8664), Status: string(constants.ProductStatusOnline), Internal: constants.EMInternalProductYes}
//		err = prw.CreateProduct(context.TODO(), EMHHZ10X8664, EMALIYUNHZX8610Components)
//		assert.NoError(t, err)
//		var allSourceProducts []ProductInfo
...
//
//		temp := make(map[string]structs.ProductInfo)
...
//		err := prw.DeleteProduct(context.TODO(), structs.ProductInfo{})
//		assert.Equal(t, errors.TIEM_PARAMETER_INVALID, err.(errors.EMError).GetCode())
//	})
...
//			Components []ProductComponentInfo
//		}
//		args := []Args{{ProductInfo: TiDBHZ50X8664, Components: TiDBALIYUNHZX8650Components},
//			{ProductInfo: TiDBHZ51ARM64, Components: TiDBALIYUNHZARM6451Components},
//			{ProductInfo: TiDBBJ50X8664, Components: TiDBALIYUNBJX8650Components},
//			{ProductInfo: TiDBBJ51X8664, Components: TiDBALIYUNBJX8651Components},
//			{ProductInfo: EMHHZ10X8664, Components: EMALIYUNHZX8610Components}}
//
//		for _, arg := range args {
//			err = prw.CreateProduct(context.TODO(), arg.ProductInfo, arg.Components)
//			assert.NoError(t, err)
//
//		}
//
...
//		err := prw.CreateSpecs(context.TODO(), make([]VendorSpec, 0))
//		assert.Equal(t, errors.TIEM_PARAMETER_INVALID, err.(errors.EMError).GetCode())
//	})
//
//	prw.DB(context.TODO()).Exec("DELETE FROM specs")
