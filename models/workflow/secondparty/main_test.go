...
var testRW *GormSecondPartyOperationReadWrite

const (
	TestWorkFlowNodeID       = "testworkflownodeid"
	TestNoSuchWorkFlowNodeID = "testnosuchworkflownodeid"
)
...
func TestMain(m *testing.M) {
	...
	framework.InitBaseFrameworkForUt(framework.ClusterService,
		func(d *framework.BaseFramework) error {
			...
			db.Migrator().CreateTable(SecondPartyOperation{})

			testRW = NewGormSecondPartyOperationReadWrite(db)
			return nil
		},
	)
	code := m.Run()
