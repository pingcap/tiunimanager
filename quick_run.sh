nohup ./bin/cluster-server --host=127.0.0.1 --port=4101 --tracer-address=127.0.0.1:6831 --metrics-port=4104 --registry-address=127.0.0.1:4106 --elasticsearch-address=127.0.0.1:9200 --skip-host-init=true &
sleep 3
